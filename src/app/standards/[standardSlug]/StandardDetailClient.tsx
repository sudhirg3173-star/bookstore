            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="grid md:grid-cols-[280px_1fr] gap-0">
                        {/* Cover panel */}
                        <div className={`flex flex-col items-center justify-center min-h-[320px] relative overflow-hidden ${standard.imageUrl ? "bg-gray-100" : "bg-gradient-to-br from-blue-700 to-blue-900 p-10 text-white"}`}>
                            {standard.imageUrl ? (
                                <Image
