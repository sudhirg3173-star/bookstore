                            ...
                            <form onSubmit={handleSearch} className="relative flex gap-2">
                                <div className="relative flex-1 flex items-center">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-2.5 bg-white/10 border border-white/20 rounded-lg text-white placeholder-black focus:outline-none focus:border-primary focus:bg-white/15 transition-all"
                                    />
                                </div>
                                <select
                                    value={searchType}
